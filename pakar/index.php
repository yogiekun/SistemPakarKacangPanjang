...
<body>
    ...
    <div class="container">
      <br><br>
      <h3 class="header center orange-text">Selamat Datang Admin</h3>
    </div>
    </div>
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light text-justify">Dimenu ini admin dapat menambah penyakit maupun gejala yang mungkin menjangkit tanaman kacang panjang.</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light text-justify">Dengan keahlian dan pengetahuan pakar tanaman kacang panjang maka aplikasi akan mendapat informasi yang lengkap mengenai jenis penyakit, gejala, keterangan penyakit dan cara penanganan yang tepat.</p>
          </div>
        </div>
