<?php
    ...
    $txtPenanganan = isset($_POST['txtPenanganan']) ? $_POST['txtPenanganan'] : '';
...
<body>
    ...
    <div class="col-md-12 blue lighten-5">
        <div class="section no-pad-bot container" id="index-banner">
            <div>
                <h3 class="header center orange-text">Tambah Penyakit</h3>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8 col-md-offset-2 content">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                  <form name="form1" method="post" action="penyakitTambahFungsi.php">
                    <table class="table">
                      <tr>
                        <td>Kode</td>
                        <td>
                          <input name="txtKode" type="text" maxlength="3" size="6" value="<?php echo $txtKode; ?>" placeholder="format 'P00' P lalu nomor urut tanpa spasi">
                      ...
                      <tr>
                        <td>Info Penyakit</td>
                        <td>
                          <textarea name="txtInfoPenyakit" cols="50" rows="4" value="<?php echo $txtInfoPenyakit; ?>"></textarea>
                        </td>
                      </tr>
                      <tr>
                        <td>Penanganan</td>
                        <td>
                          <textarea name="txtPenanganan" cols="50" rows="4" value="<?php echo $txtPenanganan; ?>"></textarea>
                        </td>
                      </tr>
                      <tr>
                        <td>Gambar</td>
                        <td>
                        <input name="txtGambar" type="text" value="<?php echo $txtGambar; ?>" placeholder="masukan url gambar">
                        </td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
